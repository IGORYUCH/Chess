    ...
    def run(self) -> None:
        while True:
            ...
            try:
                ...
                ready_clients.append(first_player)
                ready_clients.append(second_player)
    ...
    def run(self):
        ...
        while True:
            ...
            if 'SELECT' in client_data:
                loop.add_event2({'type':'select','x':int(data_words[1]), 'y':int(data_words[2]),'caller':self})
