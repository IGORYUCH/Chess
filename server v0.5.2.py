    ...
    def run(self):
        ...
        while True:
            ...
            if 'MOVE' in client_data:
                loop.add_event2({'type':'move','x':int(data_words[1]), 'y':int(data_words[2]),'caller':self})
            ...
            if self.white_step:
                if 0 <= x <=7 and 0<= y <= 7:
                    if [x,y] != self.selected_figure:
                        ...
                        self.black_player.send_msg('MOVE '+ str(100) + ' '+ str(100))
                        self.white_player.send_msg('MOVE '+ str(100) + ' '+ str(100))
                else:
                    self.black_player.send_msg('MOVE '+ str(100) + ' '+ str(100))
                    self.white_player.send_msg('MOVE '+ str(100) + ' '+ str(100))
            else:
